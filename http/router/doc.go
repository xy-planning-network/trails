...
DefaultRouter utilizes github.com/gorilla/mux.Mux for most of its implementation.
...
Before a request gets to a handler, though, any middlewares added to the Route are called in the order they appear.
